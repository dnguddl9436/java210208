 ...
 * java.lang이 아니 ㄴ패키지는 모두 import대상입니다.
 * 
 */
...
public class PrintExam {
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);//local device-서버가 아니다.-동기화는 불가-예전의 데이터를 계속 가지고 있다.-새로 등록된 운동선수에 대한 정보가 없다. -FIFA2021
		Scanner sc2 = null;
